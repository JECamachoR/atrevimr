...
export default function StepperProfile(props: Props): React.ReactElement {
	return (
					...
					<View style={styles.cont1}>
						<View style={styles.profileImg}>
							{props.selectedImg ? (
								...
								<Image
									source={require("../../assets/images/createProfileForm/noProfileImg.png")}
									resizeMode="contain"
									style={styles.pImg}
								/>
							)}
							<TouchableOpacity style={styles.editImg} onPress={props.onSelectImg}>
