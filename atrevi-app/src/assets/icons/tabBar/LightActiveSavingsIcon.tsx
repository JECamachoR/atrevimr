...
function SvgLightActiveSavingsIcon(props: SvgProps) {
  return (
    <Svg
      width={43}
      height={22}
    ...
    >
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.373 13.186C1.998 13.186.04 15.153 0 17.582c-.04 2.43 1.853 4.4 4.227 4.4l.544.001a18.098 18.098 0 01.143-8.796h-.542zM38.083 22a18.166 18.166 0 00.617-4.398 17.91 17.91 0 00-.47-4.399h.542c2.375.002 4.267 1.972 4.227 4.4-.04 2.43-1.997 4.398-4.372 4.397h-.543z"
        fill="#3F51B5"
      />
      <Path
        fillRule="evenodd"
...
export default SvgLightActiveSavingsIcon;
