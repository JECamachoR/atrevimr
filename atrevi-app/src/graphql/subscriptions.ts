...
export const onCreateCounted = /* GraphQL */ `
  subscription OnCreateCounted($owner: String!) {
    onCreateCounted(owner: $owner) {
      id
      owner
      createdAt
      updatedAt
...
export const onUpdateCounted = /* GraphQL */ `
  subscription OnUpdateCounted($owner: String!) {
    onUpdateCounted(owner: $owner) {
      id
      owner
      createdAt
      updatedAt
...
export const onDeleteCounted = /* GraphQL */ `
  subscription OnDeleteCounted($owner: String!) {
    onDeleteCounted(owner: $owner) {
      id
      owner
      createdAt
      updatedAt
