...
export default function TheBasic({ navigation }: Props): React.ReactElement {
	...
	return (
		<View style={styles.container}>
			...
			<View style={styles.BirthHeading}>
				<Text style={{ fontSize: rf(20), fontWeight: "700" }}>{t("Birthdate")}</Text>
			</View>
			{/* BirthHeading */}
			{/* BirthCards */}
			...
			<View style={styles.GenderHeading}>
				<Text style={{ fontSize: rf(20), fontWeight: "700" }}>{t("Gender")}</Text>
			</View>
			{/* GenderHeading */}
			{/* GenderCrads */}
